    ...
    <table class="table table-bordered table-hover table-striped table-sm">
        ...
        while ($row = mysqli_fetch_array($show)) {
            ...
            <tr>
                ...
                <td class="text-center"><a href="#" class="btn btn-success" data-toggle="modal" data-target="#myModal">Invest</a></td>
            </tr>
        <?php } ?>
    </table>
</div>
    ...
    <div class="modal-dialog" role="form">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Invest</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="post" action="addCrypto.php" class="form-group">
                    ...
                    <div class="form-group">
                        <a href=""><button type="submit" class="btn btn-success">Invest</button>
                    </div>
                </form>
            </div>
